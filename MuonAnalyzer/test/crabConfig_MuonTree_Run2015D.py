...
config.General.requestName = 'MuonEfficiencyTree_Run2015D_Apr07_recovery'
...
config.Data.lumiMask = './crab_projects/crab_MuonEfficiencyTree_Run2015D_Apr07/results/notFinishedLumis.json'
config.Data.allowNonValidInputDataset = False
#config.Data.publication = True
config.Data.outLFNDirBase = '/store/user/sturdy/MuonEfficiency'
config.Data.outputDatasetTag = 'MuonEfficiencyTree_Run2015D_Apr07_recovery'
