...
config.General.requestName = 'CosmicMuonAnalysis_data_interfill_RunD_Apr7_2016'
...
config.Data.lumiMask = '/afs/cern.ch/work/s/szaleski/private/CMSSW_7_4_12/src/WSUDiLeptons/MuonAnalyzer/test/interfillRunD_json.txt'
