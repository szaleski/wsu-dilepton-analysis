...
config.General.requestName = 'MuonEfficiencyTree_Run2015A_Apr07'
...
config.Data.inputDataset = '/Cosmics/Run2015A-CosmicSP-20Jan2016-v1/RAW-RECO'
...
config.Data.outputDatasetTag = 'MuonEfficiencyTree_Run2015A_Apr07'
