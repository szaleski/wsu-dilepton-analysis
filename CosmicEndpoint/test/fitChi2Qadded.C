{
  TFile *file = new TFile("/afs/cern.ch/work/s/szaleski/private/CMSSW_7_6_3_patch2/src/WSUDiLeptons/CosmicEndpoint/test/Data2MCQaddedQsep.root", "READ");
  TFile *g = new TFile("chi2FitQadded.root","RECREATE");
 ...
 can->Update();
 can->Write();
 can->SaveAs("~/public/html/cosmics/data_MCchi2FitP2Qadded.png");
 can->SaveAs("/afs/cern.ch/work/s/szaleski/private/CMSSW_7_6_3_patch2/src/WSUDiLeptons/CosmicEndpoint/test/Chi2Plots/data_MCchi2FitP2Qadded.C");
