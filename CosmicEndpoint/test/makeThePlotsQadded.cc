...
void makeThePlotsQadded(std::string const& inFile1, std::string const& inFile2, std::string const& oDir, int numBin){
...
void plotIt(TH1F *mcHist, TH1F *dataHist, std::string const& plotName, std::string const& oDir, Double_t binWidth, double stepSize, int numBin, double chi2, int ndof, double intBefore, double intAfter, double intData){
  ...
  */
  ...
  tmpCanvas->SaveAs(TString(oDir+"/curvature_"+plotName+legendText3.str()+"NewQadded.png"));

  tmpCanvas->SaveAs(TString("~/public/html/cosmics/curvature_"+plotName+legendText3.str()+"NewQadded.png"));
