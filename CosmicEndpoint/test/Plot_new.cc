...
void Plot(std::string const& file1)
{
  ...
  TH1F *h_looseMuMinusChi2 = new TH1F("LooseMuonChi2","LooseMuonChi2", 100, 0, 50);
  TH1F *h_looseMuUpperMinusChi2 = new TH1F("UpperLooseMuonChi2","UpperLooseMuonChi2", 100, 0, 50);
  TH1F *h_looseMuPlusChi2 = new TH1F("AntiLooseMuonChi2","AntiLooseMuonChi2", 100, 0, 50);
  TH1F *h_looseMuUpperPlusChi2 = new TH1F("UpperAntiLooseMuonChi2","UpperAntiLooseMuonChi2", 100, 0, 50);
  TH1F *h_looseMuLowerMinusChi2 = new TH1F("LowerLooseMuonChi2","LowerLooseMuonChi2", 100, 0, 50);
  TH1F *h_looseMuLowerPlusChi2 = new TH1F("LowerAntiLooseMuonChi2","LowerAntiLooseMuonChi2", 100, 0, 50);
  TH1F *h_looseMuMinusNdof = new TH1F("LooseMuonNdof","LooseMuonNdof", 100, 0, 50);
  TH1F *h_looseMuUpperMinusNdof = new TH1F("UpperLooseMuonNdof","UpperLooseMuonNdof", 100, 0, 50);
  TH1F *h_looseMuPlusNdof = new TH1F("AntiLooseMuonNdof","AntiLooseMuonNdof", 100, 0, 50);
  TH1F *h_looseMuUpperPlusNdof = new TH1F("UpperAntiLooseMuonNdof","UpperAntiLooseMuonNdof", 100, 0, 50);
  TH1F *h_looseMuLowerMinusNdof = new TH1F("LowerLooseMuonNdof","LowerLooseMuonNdof", 100, 0, 50);
  TH1F *h_looseMuLowerPlusNdof = new TH1F("LowerAntiLooseMuonNdof","LowerAntiLooseMuonNdof", 100, 0, 50);
TH1F *h_looseMuMinusCharge = new TH1F("LooseMuonCharge","LooseMuonCharge", 10, -2, 2);
  TH1F *h_looseMuUpperMinusCharge = new TH1F("UpperLooseMuonCharge","UpperLooseMuonCharge", 10, -2, 2);
  TH1F *h_looseMuPlusCharge = new TH1F("AntiLooseMuonCharge","AntiLooseMuonCharge", 10, -2, 2);
  TH1F *h_looseMuUpperPlusCharge = new TH1F("UpperAntiLooseMuonCharge","UpperAntiLooseMuonCharge", 10, -2, 2);
  TH1F *h_looseMuLowerMinusCharge = new TH1F("LowerLooseMuonCharge","LowerLooseMuonCharge", 10, -2, 2);
  TH1F *h_looseMuLowerPlusCharge = new TH1F("LowerAntiLooseMuonCharge","LowerAntiLooseMuonCharge", 10, -2, 2);
TH1F *h_looseMuMinusCurve = new TH1F("LooseMuonCurve","LooseMuonCurve", 100, -1, 1);
  TH1F *h_looseMuUpperMinusCurve = new TH1F("UpperLooseMuonCurve","UpperLooseMuonCurve", 100, -1, 1);
  TH1F *h_looseMuPlusCurve = new TH1F("AntiLooseMuonCurve","AntiLooseMuonCurve", 100, -1, 1);
  TH1F *h_looseMuUpperPlusCurve = new TH1F("UpperAntiLooseMuonCurve","UpperAntiLooseMuonCurve", 100, -1, 1);
  TH1F *h_looseMuLowerMinusCurve = new TH1F("LowerLooseMuonCurve","LowerLooseMuonCurve", 100, -1, 1);
  TH1F *h_looseMuLowerPlusCurve = new TH1F("LowerAntiLooseMuonCurve","LowerAntiLooseMuonCurve", 100, -1, 1);
TH1F *h_looseMuMinusDxy = new TH1F("LooseMuonDxy","LooseMuonDxy", 100, -150, 150);
  TH1F *h_looseMuUpperMinusDxy = new TH1F("UpperLooseMuonDxy","UpperLooseMuonDxy", 100, -150, 1500);
  TH1F *h_looseMuPlusDxy = new TH1F("AntiLooseMuonDxy","AntiLooseMuonDxy", 100, -150, 1500);
  TH1F *h_looseMuUpperPlusDxy = new TH1F("UpperAntiLooseMuonDxy","UpperAntiLooseMuonDxy", 100, -150, 150);
  TH1F *h_looseMuLowerMinusDxy = new TH1F("LowerLooseMuonDxy","LowerLooseMuonDxy", 100, -150, 150);
  TH1F *h_looseMuLowerPlusDxy = new TH1F("LowerAntiLooseMuonDxy","LowerAntiLooseMuonDxy", 100, -150, 150);
TH1F *h_looseMuMinusDz = new TH1F("LooseMuonDz","LooseMuonDz", 100, -300, 300);
  TH1F *h_looseMuUpperMinusDz = new TH1F("UpperLooseMuonDz","UpperLooseMuonDz", 100, -300, 300);
  TH1F *h_looseMuPlusDz = new TH1F("AntiLooseMuonDz","AntiLooseMuonDz", 100, -300, 300);
  TH1F *h_looseMuUpperPlusDz = new TH1F("UpperAntiLooseMuonDz","UpperAntiLooseMuonDz", 100, -300, 300);
  TH1F *h_looseMuLowerMinusDz = new TH1F("LowerLooseMuonDz","LowerLooseMuonDz", 100, -300, 300);
  TH1F *h_looseMuLowerPlusDz = new TH1F("LowerAntiLooseMuonDz","LowerAntiLooseMuonDz", 100, -300, 300);
TH1F *h_looseMuMinusPixelHits = new TH1F("LooseMuonPixelHits","LooseMuonPixelHits", 20, 0, 20);
  TH1F *h_looseMuUpperMinusPixelHits = new TH1F("UpperLooseMuonPixelHits","UpperLooseMuonPixelHits", 20, 0, 20);
  TH1F *h_looseMuPlusPixelHits = new TH1F("AntiLooseMuonPixelHits","AntiLooseMuonPixelHits", 20, 0, 20);
  TH1F *h_looseMuUpperPlusPixelHits = new TH1F("UpperAntiLooseMuonPixelHits","UpperAntiLooseMuonPixelHits", 20, 0, 20);
  TH1F *h_looseMuLowerMinusPixelHits = new TH1F("LowerLooseMuonPixelHits","LowerLooseMuonPixelHits", 20, 0, 20);
  TH1F *h_looseMuLowerPlusPixelHits = new TH1F("LowerAntiLooseMuonPixelHits","LowerAntiLooseMuonPixelHits", 20, 0, 20);
TH1F *h_looseMuMinusTrackerHits = new TH1F("LooseMuonTrackerHits","LooseMuonTrackerHits", 30, 0, 30);
  TH1F *h_looseMuUpperMinusTrackerHits = new TH1F("UpperLooseMuonTrackerHits","UpperLooseMuonTrackerHits", 30, 0, 30);
  TH1F *h_looseMuPlusTrackerHits = new TH1F("AntiLooseMuonTrackerHits","AntiLooseMuonTrackerHits", 30, 0, 30);
  TH1F *h_looseMuUpperPlusTrackerHits = new TH1F("UpperAntiLooseMuonTrackerHits","UpperAntiLooseMuonTrackerHits", 30, 0, 30);
  TH1F *h_looseMuLowerMinusTrackerHits = new TH1F("LowerLooseMuonTrackerHits","LowerLooseMuonTrackerHits", 30, 0, 30);
  TH1F *h_looseMuLowerPlusTrackerHits = new TH1F("LowerAntiLooseMuonTrackerHits","LowerAntiLooseMuonTrackerHits", 30, 0, 30);
TH1F *h_looseMuMinusMuonStationHits = new TH1F("LooseMuonLooseMuonStationHits","LooseMuonLooseMuonStationHits", 10, 0, 10);
  TH1F *h_looseMuUpperMinusMuonStationHits = new TH1F("UpperLooseMuonLooseMuonStationHits","UpperLooseMuonLooseMuonStationHits", 10, 0, 10);
  TH1F *h_looseMuPlusMuonStationHits = new TH1F("AntiLooseMuonLooseMuonStationHits","AntiLooseMuonLooseMuonStationHits", 10, 0, 10);
  TH1F *h_looseMuUpperPlusMuonStationHits = new TH1F("UpperAntiLooseMuonLooseMuonStationHits","UpperAntiLooseMuonLooseMuonStationHits", 10, 0, 10);
  TH1F *h_looseMuLowerMinusMuonStationHits = new TH1F("LowerLooseMuonLooseMuonStationHits","LowerLooseMuonLooseMuonStationHits", 10, 0, 10);
  TH1F *h_looseMuLowerPlusMuonStationHits = new TH1F("LowerAntiLooseMuonLooseMuonStationHits","LowerAntiLooseMuonLooseMuonStationHits", 10, 0, 10);
TH1F *h_looseMuMinusValidHits = new TH1F("LooseMuonValidHits","LooseMuonValidHits", 40, 0, 40);
  TH1F *h_looseMuUpperMinusValidHits = new TH1F("UpperLooseMuonValidHits","UpperLooseMuonValidHits", 40, 0, 40);
  TH1F *h_looseMuPlusValidHits = new TH1F("AntiLooseMuonValidHits","AntiLooseMuonValidHits", 40, 0, 40);
  TH1F *h_looseMuUpperPlusValidHits = new TH1F("UpperAntiLooseMuonValidHits","UpperAntiLooseMuonValidHits", 40, 0, 40);
  TH1F *h_looseMuLowerMinusValidHits = new TH1F("LowerLooseMuonValidHits","LowerLooseMuonValidHits", 40, 0, 40);
  TH1F *h_looseMuLowerPlusValidHits = new TH1F("LowerAntiLooseMuonValidHits","LowerAntiLooseMuonValidHits", 40, 0, 40);
TH1F *h_looseMuMinusMatchedMuonStations = new TH1F("LooseMuonMatchedLooseMuonStations","LooseMuonMatchedLooseMuonStations", 10, 0, 10);
  TH1F *h_looseMuUpperMinusMatchedMuonStations = new TH1F("UpperLooseMuonMatchedLooseMuonStations","UpperLooseMuonMatchedLooseMuonStations", 10, 0, 10);
  TH1F *h_looseMuPlusMatchedMuonStations = new TH1F("AntiLooseMuonMatchedLooseMuonStations","AntiLooseMuonMatchedLooseMuonStations", 10, 0, 10);
  TH1F *h_looseMuUpperPlusMatchedMuonStations = new TH1F("UpperAntiLooseMuonMatchedLooseMuonStations","UpperAntiLooseMuonMatchedLooseMuonStations", 10, 0, 10);
  TH1F *h_looseMuLowerMinusMatchedMuonStations = new TH1F("LowerLooseMuonMatchedLooseMuonStations","LowerLooseMuonMatchedLooseMuonStations", 10, 0, 10);
  TH1F *h_looseMuLowerPlusMatchedMuonStations = new TH1F("LowerAntiLooseMuonMatchedLooseMuonStations","LowerAntiLooseMuonMatchedLooseMuonStations", 10, 0, 10);
TH1F *h_looseMuMinusPtError = new TH1F("LooseMuonPtError","LooseMuonPtError", 75, 0, 150);
  TH1F *h_looseMuUpperMinusPtError = new TH1F("UpperLooseMuonPtError","UpperLooseMuonPtError", 75, 0, 150);
  TH1F *h_looseMuPlusPtError = new TH1F("AntiLooseMuonPtError","AntiLooseMuonPtError", 75, 0, 150);
  TH1F *h_looseMuUpperPlusPtError = new TH1F("UpperAntiLooseMuonPtError","UpperAntiLooseMuonPtError", 75, 0, 150);
  TH1F *h_looseMuLowerMinusPtError = new TH1F("LowerLooseMuonPtError","LowerLooseMuonPtError", 75, 0, 150);
  TH1F *h_looseMuLowerPlusPtError = new TH1F("LowerAntiLooseMuonPtError","LowerAntiLooseMuonPtError", 75, 0, 150);
TH1F *h_looseMuMinusDxyError = new TH1F("LooseMuonDxyError","LooseMuonDxyError", 100, -200, 200);
  TH1F *h_looseMuUpperMinusDxyError = new TH1F("UpperLooseMuonDxyError","UpperLooseMuonDxyError", 100, -200, 200);
  TH1F *h_looseMuPlusDxyError = new TH1F("AntiLooseMuonDxyError","AntiLooseMuonDxyError", 100, -20, 200);
  TH1F *h_looseMuUpperPlusDxyError = new TH1F("UpperAntiLooseMuonDxyError","UpperAntiLooseMuonDxyError", 100, -200, 200);
  TH1F *h_looseMuLowerMinusDxyError = new TH1F("LowerLooseMuonDxyError","LowerLooseMuonDxyError", 100, -200, 200);
  TH1F *h_looseMuLowerPlusDxyError = new TH1F("LowerAntiLooseMuonDxyError","LowerAntiLooseMuonDxyError", 100, -200, 200);
TH1F *h_looseMuMinusDzError = new TH1F("LooseMuonDzError","LooseMuonDzError", 100, -200, 200);
  TH1F *h_looseMuUpperMinusDzError = new TH1F("UpperLooseMuonDzError","UpperLooseMuonDzError", 100, -200, 200);
  TH1F *h_looseMuPlusDzError = new TH1F("AntiLooseMuonDzError","AntiLooseMuonDzError", 100, -200, 200);
  TH1F *h_looseMuUpperPlusDzError = new TH1F("UpperAntiLooseMuonDzError","UpperAntiLooseMuonDzError", 100, -200, 200);
  TH1F *h_looseMuLowerMinusDzError = new TH1F("LowerLooseMuonDzError","LowerLooseMuonDzError", 100, -200, 200);
  TH1F *h_looseMuLowerPlusDzError = new TH1F("LowerAntiLooseMuonDzError","LowerAntiLooseMuonDzError", 100, -200, 200);
  TH1F *h_looseMuMinusPt = new TH1F("LooseMuonPt","LooseMuonPt", 1000, 0, 2000);
  TH1F *h_looseMuUpperMinusPt = new TH1F("UpperLooseMuonPt","UpperLooseMuonPt", 1000, 0, 2000);
  TH1F *h_looseMuPlusPt = new TH1F("AntiLooseMuonPt","AntiLooseMuonPt", 1000, 0, 2000);
  TH1F *h_looseMuUpperPlusPt = new TH1F("UpperAntiLooseMuonPt","UpperAntiLooseMuonPt", 1000, 0, 2000);
  TH1F *h_looseMuLowerMinusPt = new TH1F("LowerLooseMuonPt","LowerLooseMuonPt", 1000, 0, 2000);
  TH1F *h_looseMuLowerPlusPt = new TH1F("LowerAntiLooseMuonPt","LowerAntiLooseMuonPt", 1000, 0, 2000);
 TH1F *h_looseMuMinusEta = new TH1F("LooseMuonEta","LooseMuonEta", 42, -10, 10);
  TH1F *h_looseMuUpperMinusEta = new TH1F("UpperLooseMuonEta","UpperLooseMuonEta", 42, -10, 10);
  TH1F *h_looseMuPlusEta = new TH1F("AntiLooseMuonEta","AntiLooseMuonEta", 42, -10, 10);
  TH1F *h_looseMuUpperPlusEta = new TH1F("UpperAntiLooseMuonEta","UpperAntiLooseMuonEta", 42, -10, 10);
  TH1F *h_looseMuLowerMinusEta = new TH1F("LowerLooseMuonEta","LowerLooseMuonEta", 42, -10, 10);
  TH1F *h_looseMuLowerPlusEta = new TH1F("LowerAntiLooseMuonEta","LowerAntiLooseMuonEta", 42, -10, 10);
 TH1F *h_looseMuMinusPhi = new TH1F("LooseMuonPhi","LooseMuonPhi", 90, -4, 4);
  TH1F *h_looseMuUpperMinusPhi = new TH1F("UpperLooseMuonPhi","UpperLooseMuonPhi", 90, -4, 4);
  TH1F *h_looseMuPlusPhi = new TH1F("AntiLooseMuonPhi","AntiLooseMuonPhi", 90, -4, 4);
  TH1F *h_looseMuUpperPlusPhi = new TH1F("UpperAntiLooseMuonPhi","UpperAntiLooseMuonPhi", 90, -4, 4);
  TH1F *h_looseMuLowerMinusPhi = new TH1F("LowerLooseMuonPhi","LowerLooseMuonPhi", 90, -4, 4);
  TH1F *h_looseMuLowerPlusPhi = new TH1F("LowerAntiLooseMuonPhi","LowerAntiLooseMuonPhi", 90, -4, 4);
  TH1F *h_looseMuMinusTrackPt = new TH1F("LooseMuonTrackPt","LooseMuonTrackPt", 1000, 0, 2000);
  TH1F *h_looseMuUpperMinusTrackPt = new TH1F("UpperLooseMuonTrackPt","UpperLooseMuonTrackPt", 1000, 0, 2000);
  TH1F *h_looseMuPlusTrackPt = new TH1F("AntiLooseMuonTrackPt","AntiLooseMuonTrackPt", 1000, 0, 2000);
  TH1F *h_looseMuUpperPlusTrackPt = new TH1F("UpperAntiLooseMuonTrackPt","UpperAntiLooseMuonTrackPt", 1000, 0, 2000);
  TH1F *h_looseMuLowerMinusTrackPt = new TH1F("LowerLooseMuonTrackPt","LowerLooseMuonTrackPt", 1000, 0, 2000);
  TH1F *h_looseMuLowerPlusTrackPt = new TH1F("LowerAntiLooseMuonTrackPt","LowerAntiLooseMuonTrackPt", 1000, 0, 2000);
  TH1F *h_looseMuMinusTrackEta = new TH1F("LooseMuonTrackEta","LooseMuonTrackEta", 42, -10, 10);
  TH1F *h_looseMuUpperMinusTrackEta = new TH1F("UpperLooseMuonTrackEta","UpperLooseMuonTrackEta", 42, -10, 10);
  TH1F *h_looseMuPlusTrackEta = new TH1F("AntiLooseMuonTrackEta","AntiLooseMuonTrackEta", 42, -10, 10);
  TH1F *h_looseMuUpperPlusTrackEta = new TH1F("UpperAntiLooseMuonTrackEta","UpperAntiLooseMuonTrackEta", 42, -10, 10);
  TH1F *h_looseMuLowerMinusTrackEta = new TH1F("LowerLooseMuonTrackEta","LowerLooseMuonTrackEta", 42, -10, 10);
  TH1F *h_looseMuLowerPlusTrackEta = new TH1F("LowerAntiLooseMuonTrackEta","LowerAntiLooseMuonTrackEta", 42, -10, 10);
  TH1F *h_looseMuMinusTrackPhi = new TH1F("LooseMuonTrackPhi","LooseMuonTrackPhi", 90, -4, 4);
  TH1F *h_looseMuUpperMinusTrackPhi = new TH1F("UpperLooseMuonTrackPhi","UpperLooseMuonTrackPhi", 90, -4, 4);
  TH1F *h_looseMuPlusTrackPhi = new TH1F("AntiLooseMuonTrackPhi","AntiLooseMuonTrackPhi", 90, -4, 4);
  TH1F *h_looseMuUpperPlusTrackPhi = new TH1F("UpperAntiLooseMuonTrackPhi","UpperAntiLooseMuonTrackPhi", 90, -4, 4);
  TH1F *h_looseMuLowerMinusTrackPhi = new TH1F("LowerLooseMuonTrackPhi","LowerLooseMuonTrackPhi", 90, -4, 4);
  TH1F *h_looseMuLowerPlusTrackPhi = new TH1F("LowerAntiLooseMuonTrackPhi","LowerAntiLooseMuonTrackPhi", 90, -4, 4);
  TH1F *h_looseMuMinusTrackLayersWithMeasurement = new TH1F("LooseMuonTrackLayersWithMeasurement","LooseMuonTrackLayersWithMeasurement", 100, 0, 50);
  TH1F *h_looseMuUpperMinusTrackLayersWithMeasurement = new TH1F("UpperLooseMuonTrackLayersWithMeasurement","UpperLooseMuonTrackLayersWithMeasurement", 100, 0, 50);
  TH1F *h_looseMuPlusTrackLayersWithMeasurement = new TH1F("AntiLooseMuonTrackLayersWithMeasurement","AntiLooseMuonTrackLayersWithMeasurement", 100, 0, 50);
  TH1F *h_looseMuUpperPlusTrackLayersWithMeasurement = new TH1F("UpperAntiLooseMuonTrackLayersWithMeasurement","UpperAntiLooseMuonTrackLayersWithMeasurement", 100, 0, 50);
  TH1F *h_looseMuLowerMinusTrackLayersWithMeasurement = new TH1F("LowerLooseMuonTrackLayersWithMeasurement","LowerLooseMuonTrackLayersWithMeasurement", 100, 0, 50);
  TH1F *h_looseMuLowerPlusTrackLayersWithMeasurement = new TH1F("LowerAntiLooseMuonTrackLayersWithMeasurement","LowerAntiLooseMuonTrackLayersWithMeasurement", 100, 0, 50);
...
TH1F *h_tightMuMinusDxy = new TH1F("TightMuonDxy","TightMuonDxy", 100, -150, 150);
  TH1F *h_tightMuUpperMinusDxy = new TH1F("UpperTightMuonDxy","UpperTightMuonDxy", 100, -150, 1500);
  TH1F *h_tightMuPlusDxy = new TH1F("AntiTightMuonDxy","AntiTightMuonDxy", 100, -150, 1500);
  TH1F *h_tightMuUpperPlusDxy = new TH1F("UpperAntiTightMuonDxy","UpperAntiTightMuonDxy", 100, -150, 150);
  TH1F *h_tightMuLowerMinusDxy = new TH1F("LowerTightMuonDxy","LowerTightMuonDxy", 100, -150, 150);
  TH1F *h_tightMuLowerPlusDxy = new TH1F("LowerAntiTightMuonDxy","LowerAntiTightMuonDxy", 100, -150, 150);
TH1F *h_tightMuMinusDz = new TH1F("TightMuonDz","TightMuonDz", 100, -300, 300);
  TH1F *h_tightMuUpperMinusDz = new TH1F("UpperTightMuonDz","UpperTightMuonDz", 100, -300, 300);
  TH1F *h_tightMuPlusDz = new TH1F("AntiTightMuonDz","AntiTightMuonDz", 100, -300, 300);
  TH1F *h_tightMuUpperPlusDz = new TH1F("UpperAntiTightMuonDz","UpperAntiTightMuonDz", 100, -300, 300);
  TH1F *h_tightMuLowerMinusDz = new TH1F("LowerTightMuonDz","LowerTightMuonDz", 100, -300, 300);
  TH1F *h_tightMuLowerPlusDz = new TH1F("LowerAntiTightMuonDz","LowerAntiTightMuonDz", 100, -300, 300);
...
TH1F *h_tightMuMinusPtError = new TH1F("TightMuonPtError","TightMuonPtError", 75, 0, 150);
  TH1F *h_tightMuUpperMinusPtError = new TH1F("UpperTightMuonPtError","UpperTightMuonPtError", 75, 0, 150);
  TH1F *h_tightMuPlusPtError = new TH1F("AntiTightMuonPtError","AntiTightMuonPtError", 75, 0, 150);
  TH1F *h_tightMuUpperPlusPtError = new TH1F("UpperAntiTightMuonPtError","UpperAntiTightMuonPtError", 75, 0, 150);
  TH1F *h_tightMuLowerMinusPtError = new TH1F("LowerTightMuonPtError","LowerTightMuonPtError", 75, 0, 150);
  TH1F *h_tightMuLowerPlusPtError = new TH1F("LowerAntiTightMuonPtError","LowerAntiTightMuonPtError", 75, 0, 150);
TH1F *h_tightMuMinusDxyError = new TH1F("TightMuonDxyError","TightMuonDxyError", 100, -200, 200);
  TH1F *h_tightMuUpperMinusDxyError = new TH1F("UpperTightMuonDxyError","UpperTightMuonDxyError", 100, -200, 200);
  TH1F *h_tightMuPlusDxyError = new TH1F("AntiTightMuonDxyError","AntiTightMuonDxyError", 100, -20, 200);
  TH1F *h_tightMuUpperPlusDxyError = new TH1F("UpperAntiTightMuonDxyError","UpperAntiTightMuonDxyError", 100, -200, 200);
  TH1F *h_tightMuLowerMinusDxyError = new TH1F("LowerTightMuonDxyError","LowerTightMuonDxyError", 100, -200, 200);
  TH1F *h_tightMuLowerPlusDxyError = new TH1F("LowerAntiTightMuonDxyError","LowerAntiTightMuonDxyError", 100, -200, 200);
TH1F *h_tightMuMinusDzError = new TH1F("TightMuonDzError","TightMuonDzError", 100, -200, 200);
  TH1F *h_tightMuUpperMinusDzError = new TH1F("UpperTightMuonDzError","UpperTightMuonDzError", 100, -200, 200);
  TH1F *h_tightMuPlusDzError = new TH1F("AntiTightMuonDzError","AntiTightMuonDzError", 100, -200, 200);
  TH1F *h_tightMuUpperPlusDzError = new TH1F("UpperAntiTightMuonDzError","UpperAntiTightMuonDzError", 100, -200, 200);
  TH1F *h_tightMuLowerMinusDzError = new TH1F("LowerTightMuonDzError","LowerTightMuonDzError", 100, -200, 200);
  TH1F *h_tightMuLowerPlusDzError = new TH1F("LowerAntiTightMuonDzError","LowerAntiTightMuonDzError", 100, -200, 200);
  TH1F *h_tightMuMinusPt = new TH1F("TightMuonPt","TightMuonPt", 1000, 0, 2000);
  TH1F *h_tightMuUpperMinusPt = new TH1F("UpperTightMuonPt","UpperTightMuonPt", 1000, 0, 2000);
  TH1F *h_tightMuPlusPt = new TH1F("AntiTightMuonPt","AntiTightMuonPt", 1000, 0, 2000);
  TH1F *h_tightMuUpperPlusPt = new TH1F("UpperAntiTightMuonPt","UpperAntiTightMuonPt", 1000, 0, 2000);
  TH1F *h_tightMuLowerMinusPt = new TH1F("LowerTightMuonPt","LowerTightMuonPt", 1000, 0, 2000);
  TH1F *h_tightMuLowerPlusPt = new TH1F("LowerAntiTightMuonPt","LowerAntiTightMuonPt", 1000, 0, 2000);
 TH1F *h_tightMuMinusEta = new TH1F("TightMuonEta","TightMuonEta", 42, -10, 10);
  TH1F *h_tightMuUpperMinusEta = new TH1F("UpperTightMuonEta","UpperTightMuonEta", 42, -10, 10);
  TH1F *h_tightMuPlusEta = new TH1F("AntiTightMuonEta","AntiTightMuonEta", 42, -10, 10);
  TH1F *h_tightMuUpperPlusEta = new TH1F("UpperAntiTightMuonEta","UpperAntiTightMuonEta", 42, -10, 10);
  TH1F *h_tightMuLowerMinusEta = new TH1F("LowerTightMuonEta","LowerTightMuonEta", 42, -10, 10);
  TH1F *h_tightMuLowerPlusEta = new TH1F("LowerAntiTightMuonEta","LowerAntiTightMuonEta", 42, -10, 10);
 ...
 TH1F *h_tightMuMinusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_tightMuMinusCurvePlusBias[i] = new TH1F(TString("tightMuMinusCurvePlusBias" + name.str()), TString("tightMuMinusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_tightMuMinusCurveMinusBias[i] = new TH1F(TString("tightMuMinusCurveMinusBias" + name.str()),TString("tightMuMinusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_tightMuUpperMinusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_tightMuUpperMinusCurvePlusBias[i] = new TH1F(TString("tightMuUpperMinusCurvePlusBias" + name.str()), TString("tightMuUpperMinusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_tightMuUpperMinusCurveMinusBias[i] = new TH1F(TString("tightMuUpperMinusCurveMinusBias" + name.str()),TString("tightMuUpperMinusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_tightMuLowerMinusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_tightMuLowerMinusCurvePlusBias[i] = new TH1F(TString("tightMuLowerMinusCurvePlusBias" + name.str()), TString("tightMuLowerMinusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_tightMuLowerMinusCurveMinusBias[i] = new TH1F(TString("tightMuLowerMinusCurveMinusBias" + name.str()),TString("tightMuLowerMinusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_tightMuPlusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_tightMuPlusCurvePlusBias[i] = new TH1F(TString("tightMuPlusCurvePlusBias" + name.str()), TString("tightMuPlusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_tightMuPlusCurveMinusBias[i] = new TH1F(TString("tightMuPlusCurveMinusBias" + name.str()),TString("tightMuPlusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_tightMuUpperPlusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_tightMuUpperPlusCurvePlusBias[i] = new TH1F(TString("tightMuUpperPlusCurvePlusBias" + name.str()), TString("tightMuUpperPlusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_tightMuUpperPlusCurveMinusBias[i] = new TH1F(TString("tightMuUpperPlusCurveMinusBias" + name.str()),TString("tightMuUpperPlusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_tightMuLowerPlusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_tightMuLowerPlusCurvePlusBias[i] = new TH1F(TString("tightMuLowerPlusCurvePlusBias" + name.str()), TString("tightMuLowerPlusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_tightMuLowerPlusCurveMinusBias[i] = new TH1F(TString("tightMuLowerPlusCurveMinusBias" + name.str()),TString("tightMuLowerPlusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
...
TH1F *h_muMinusDxy = new TH1F("MuonDxy","MuonDxy", 100, -150, 150);
  TH1F *h_muUpperMinusDxy = new TH1F("UpperMuonDxy","UpperMuonDxy", 100, -150, 1500);
  TH1F *h_muPlusDxy = new TH1F("AntiMuonDxy","AntiMuonDxy", 100, -150, 1500);
  TH1F *h_muUpperPlusDxy = new TH1F("UpperAntiMuonDxy","UpperAntiMuonDxy", 100, -150, 150);
  TH1F *h_muLowerMinusDxy = new TH1F("LowerMuonDxy","LowerMuonDxy", 100, -150, 150);
  TH1F *h_muLowerPlusDxy = new TH1F("LowerAntiMuonDxy","LowerAntiMuonDxy", 100, -150, 150);
TH1F *h_muMinusDz = new TH1F("MuonDz","MuonDz", 100, -300, 300);
  TH1F *h_muUpperMinusDz = new TH1F("UpperMuonDz","UpperMuonDz", 100, -300, 300);
  TH1F *h_muPlusDz = new TH1F("AntiMuonDz","AntiMuonDz", 100, -300, 300);
  TH1F *h_muUpperPlusDz = new TH1F("UpperAntiMuonDz","UpperAntiMuonDz", 100, -300, 300);
  TH1F *h_muLowerMinusDz = new TH1F("LowerMuonDz","LowerMuonDz", 100, -300, 300);
  TH1F *h_muLowerPlusDz = new TH1F("LowerAntiMuonDz","LowerAntiMuonDz", 100, -300, 300);
...
TH1F *h_muMinusPtError = new TH1F("MuonPtError","MuonPtError", 75, 0, 150);
  TH1F *h_muUpperMinusPtError = new TH1F("UpperMuonPtError","UpperMuonPtError", 75, 0, 150);
  TH1F *h_muPlusPtError = new TH1F("AntiMuonPtError","AntiMuonPtError", 75, 0, 150);
  TH1F *h_muUpperPlusPtError = new TH1F("UpperAntiMuonPtError","UpperAntiMuonPtError", 75, 0, 150);
  TH1F *h_muLowerMinusPtError = new TH1F("LowerMuonPtError","LowerMuonPtError", 75, 0, 150);
  TH1F *h_muLowerPlusPtError = new TH1F("LowerAntiMuonPtError","LowerAntiMuonPtError", 75, 0, 150);
TH1F *h_muMinusDxyError = new TH1F("MuonDxyError","MuonDxyError", 100, -200, 200);
  TH1F *h_muUpperMinusDxyError = new TH1F("UpperMuonDxyError","UpperMuonDxyError", 100, -200, 200);
  TH1F *h_muPlusDxyError = new TH1F("AntiMuonDxyError","AntiMuonDxyError", 100, -20, 200);
  TH1F *h_muUpperPlusDxyError = new TH1F("UpperAntiMuonDxyError","UpperAntiMuonDxyError", 100, -200, 200);
  TH1F *h_muLowerMinusDxyError = new TH1F("LowerMuonDxyError","LowerMuonDxyError", 100, -200, 200);
  TH1F *h_muLowerPlusDxyError = new TH1F("LowerAntiMuonDxyError","LowerAntiMuonDxyError", 100, -200, 200);
TH1F *h_muMinusDzError = new TH1F("MuonDzError","MuonDzError", 100, -200, 200);
  TH1F *h_muUpperMinusDzError = new TH1F("UpperMuonDzError","UpperMuonDzError", 100, -200, 200);
  TH1F *h_muPlusDzError = new TH1F("AntiMuonDzError","AntiMuonDzError", 100, -200, 200);
  TH1F *h_muUpperPlusDzError = new TH1F("UpperAntiMuonDzError","UpperAntiMuonDzError", 100, -200, 200);
  TH1F *h_muLowerMinusDzError = new TH1F("LowerMuonDzError","LowerMuonDzError", 100, -200, 200);
  TH1F *h_muLowerPlusDzError = new TH1F("LowerAntiMuonDzError","LowerAntiMuonDzError", 100, -200, 200);
  TH1F *h_muMinusPt = new TH1F("MuonPt","MuonPt", 1000, 0, 2000);
  TH1F *h_muUpperMinusPt = new TH1F("UpperMuonPt","UpperMuonPt", 1000, 0, 2000);
  TH1F *h_muPlusPt = new TH1F("AntiMuonPt","AntiMuonPt", 1000, 0, 2000);
  TH1F *h_muUpperPlusPt = new TH1F("UpperAntiMuonPt","UpperAntiMuonPt", 1000, 0, 2000);
  TH1F *h_muLowerMinusPt = new TH1F("LowerMuonPt","LowerMuonPt", 1000, 0, 2000);
  TH1F *h_muLowerPlusPt = new TH1F("LowerAntiMuonPt","LowerAntiMuonPt", 1000, 0, 2000);
 TH1F *h_muMinusEta = new TH1F("MuonEta","MuonEta", 42, -10, 10);
  TH1F *h_muUpperMinusEta = new TH1F("UpperMuonEta","UpperMuonEta", 42, -10, 10);
  TH1F *h_muPlusEta = new TH1F("AntiMuonEta","AntiMuonEta", 42, -10, 10);
  TH1F *h_muUpperPlusEta = new TH1F("UpperAntiMuonEta","UpperAntiMuonEta", 42, -10, 10);
  TH1F *h_muLowerMinusEta = new TH1F("LowerMuonEta","LowerMuonEta", 42, -10, 10);
  TH1F *h_muLowerPlusEta = new TH1F("LowerAntiMuonEta","LowerAntiMuonEta", 42, -10, 10);
 TH1F *h_muMinusPhi = new TH1F("MuonPhi","MuonPhi", 90, -4, 4);
  ...
  TH1F *h_muUpperMinusTrackPt = new TH1F("UpperMuonTrackPt","UpperMuonTrackPt", 1000, 0, 2000);
  TH1F *h_muPlusTrackPt = new TH1F("AntiMuonTrackPt","AntiMuonTrackPt", 1000, 0, 2000);
  TH1F *h_muUpperPlusTrackPt = new TH1F("UpperAntiMuonTrackPt","UpperAntiMuonTrackPt", 1000, 0, 2000);
  TH1F *h_muLowerMinusTrackPt = new TH1F("LowerMuonTrackPt","LowerMuonTrackPt", 1000, 0, 2000);
  TH1F *h_muLowerPlusTrackPt = new TH1F("LowerAntiMuonTrackPt","LowerAntiMuonTrackPt", 1000, 0, 2000);
  TH1F *h_muMinusTrackEta = new TH1F("MuonTrackEta","MuonTrackEta", 42, -10, 10);
  TH1F *h_muUpperMinusTrackEta = new TH1F("UpperMuonTrackEta","UpperMuonTrackEta", 42, -10, 10);
  TH1F *h_muPlusTrackEta = new TH1F("AntiMuonTrackEta","AntiMuonTrackEta", 42, -10, 10);
  TH1F *h_muUpperPlusTrackEta = new TH1F("UpperAntiMuonTrackEta","UpperAntiMuonTrackEta", 42, -10, 10);
  TH1F *h_muLowerMinusTrackEta = new TH1F("LowerMuonTrackEta","LowerMuonTrackEta", 42, -10, 10);
  TH1F *h_muLowerPlusTrackEta = new TH1F("LowerAntiMuonTrackEta","LowerAntiMuonTrackEta", 42, -10, 10);
 ...
 TH1F *h_muMinusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_muMinusCurvePlusBias[i] = new TH1F(TString("muMinusCurvePlusBias" + name.str()), TString("muMinusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_muMinusCurveMinusBias[i] = new TH1F(TString("muMinusCurveMinusBias" + name.str()),TString("muMinusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_muUpperMinusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_muUpperMinusCurvePlusBias[i] = new TH1F(TString("muUpperMinusCurvePlusBias" + name.str()), TString("muUpperMinusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_muUpperMinusCurveMinusBias[i] = new TH1F(TString("muUpperMinusCurveMinusBias" + name.str()),TString("muUpperMinusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_muLowerMinusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_muLowerMinusCurvePlusBias[i] = new TH1F(TString("muLowerMinusCurvePlusBias" + name.str()), TString("muLowerMinusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_muLowerMinusCurveMinusBias[i] = new TH1F(TString("muLowerMinusCurveMinusBias" + name.str()),TString("muLowerMinusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_muPlusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_muPlusCurvePlusBias[i] = new TH1F(TString("muPlusCurvePlusBias" + name.str()), TString("muPlusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_muPlusCurveMinusBias[i] = new TH1F(TString("muPlusCurveMinusBias" + name.str()),TString("muPlusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_muUpperPlusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_muUpperPlusCurvePlusBias[i] = new TH1F(TString("muUpperPlusCurvePlusBias" + name.str()), TString("muUpperPlusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_muUpperPlusCurveMinusBias[i] = new TH1F(TString("muUpperPlusCurveMinusBias" + name.str()),TString("muUpperPlusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
 TH1F *h_muLowerPlusCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_muLowerPlusCurvePlusBias[i] = new TH1F(TString("muLowerPlusCurvePlusBias" + name.str()), TString("muLowerPlusCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_muLowerPlusCurveMinusBias[i] = new TH1F(TString("muLowerPlusCurveMinusBias" + name.str()),TString("muLowerPlusCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }
  ...
  TH1F *h_upperDxy = new TH1F("upperDxy","upperDxy", 100, -150, 150);
  TH1F *h_upperDz = new TH1F("upperDz","upperDz", 100, -300, 300);
  ...
  TH1F *h_upperPtError = new TH1F("upperPtError","upperPtError", 75, 0, 150);
  TH1F *h_upperDxyError = new TH1F("upperDxyError","upperDxyError", 100, -200, 200);
  TH1F *h_upperDzError = new TH1F("upperDzError","upperDzError", 100, -200, 200);
  TH1F *h_upperPt = new TH1F("upperPt","upperPt", 1000, 0, 2000);
  TH1F *h_upperEta = new TH1F("upperEta","upperEta", 42, -10, 10);
  TH1F *h_upperPhi = new TH1F("upperPhi","upperPhi", 90, -4, 4);
  TH1F *h_upperTrackPt = new TH1F("upperTrackPt","upperTrackPt", 1000, 0, 2000);
  TH1F *h_upperTrackEta = new TH1F("upperTrackEta","upperTrackEta", 42, -10, 10);
 ...
 TH1F *h_upperCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_upperCurvePlusBias[i] = new TH1F(TString("upperCurvePlusBias" + name.str()), TString("upperCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_upperCurveMinusBias[i] = new TH1F(TString("upperCurveMinusBias" + name.str()),TString("upperCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  } 
  ...
  TH1F *h_lowerDxy = new TH1F("lowerDxy","lowerDxy", 100, -150, 150);
  TH1F *h_lowerDz = new TH1F("lowerDz","lowerDz", 100, -200, 200);
  ...
  TH1F *h_lowerPtError = new TH1F("lowerPtError","lowerPtError", 75, 0, 150);
  TH1F *h_lowerDxyError = new TH1F("lowerDxyError","lowerDxyError", 100, -200, 200);
  TH1F *h_lowerDzError = new TH1F("lowerDzError","lowerDzError", 100, -200, 200);
  TH1F *h_lowerPt = new TH1F("lowerPt","lowerPt", 1000, 0, 2000);
  TH1F *h_lowerEta = new TH1F("lowerEta","lowerEta", 42, -10, 10);
  TH1F *h_lowerPhi = new TH1F("lowerPhi","lowerPhi", 90, -4, 4);
  TH1F *h_lowerTrackPt = new TH1F("lowerTrackPt","lowerTrackPt", 1000, 0, 2000);
  TH1F *h_lowerTrackEta = new TH1F("lowerTrackEta","lowerTrackEta", 42, -10, 10);
 ...
 TH1F *h_lowerCurvePlusBias[nBiasBins];
  ...
  for(int i =0; i < nBiasBins; ++i){
    std::stringstream name;
    name << std::setw(3) << std::setfill('0') << i + 1;
    h_lowerCurvePlusBias[i] = new TH1F(TString("lowerCurvePlusBias" + name.str()), TString("lowerCurvePlusBias" + name.str()), 50, 0, 0.1);
    h_lowerCurveMinusBias[i] = new TH1F(TString("lowerCurveMinusBias" + name.str()),TString("lowerCurveMinusBias" + name.str()), 50, 0, 0.1);  
    //    std::cout << "\nCreated bias empty histograms number: " << i << std::endl;
  }   
