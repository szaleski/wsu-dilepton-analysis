{
  TFile *file = new TFile("/afs/cern.ch/work/s/szaleski/private/CMSSW_7_6_3_patch2/src/WSUDiLeptons/CosmicEndpoint/test/Data2MCQaddedSSQsep.root", "READ");
  TFile *g = new TFile("chi2FitQaddedSS.root","RECREATE");
  ...
  TH1F *graph = (TH1F*)file->Get("TunePChi2vCurvePlus;1"); //file->Get("tunep_Chi2");
  
  g->cd();


    TH1F* dataHistRebin = (TH1F*)file->Get("TunePCraftPlus_Rebinned;1");
    std::cout << "\nGot the first histo\n";
 ...
 can->Update();
 can->Write();
 can->SaveAs("~/public/html/cosmics/data_MCchi2FitP2QaddedSS.png");
 can->SaveAs("/afs/cern.ch/work/s/szaleski/private/CMSSW_7_6_3_patch2/src/WSUDiLeptons/CosmicEndpoint/test/Chi2Plots/data_MCchi2FitP2QaddedSS.C");
